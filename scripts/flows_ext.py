...
class FlowSequential(nn.Sequential):
    ...
    def log_probs(self, inputs, cond_inputs=None):
        u, log_jacob = self(inputs, cond_inputs=cond_inputs)
...
class FLOWextDist(nn.Sequential):
    def __init__(self, mu, sigma, model_type='maf', num_blocks=1, num_inputs=100, num_hidden=100):
        super(FLOWextDist, self).__init__()
        self.mu = mu
        self.sigma = sigma
    ...
    def log_prob(self, inputs, cond_inputs=None):
        ...
        u, log_jacob = self.model(inputs, cond_inputs=cond_inputs)
